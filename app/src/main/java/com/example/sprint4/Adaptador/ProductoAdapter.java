package com.example.sprint4.Adaptador;
...
import com.example.sprint4.Catalogo;
import com.example.sprint4.DB.DBFirebase;
import com.example.sprint4.Form;
import com.example.sprint4.Info;
import com.example.sprint4.R;
...
public class ProductoAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view = layoutInflater.inflate(R.layout.template_product, null);
        ...
        imgProduct.setImageResource(R.drawable.clave_sol);
        ...
        btnEditProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("dATOS", producto.getLongitud());
                context.startActivity(intent);
            }
        });
        return view;
